...
import model.MReportesDAO;

/**
 * Hecho con <3 por: 
 * @author Alexis (GarciHard)
 */
public class VRecursosHumanosReportes2 extends JDialog {

    private JPanel pnlBackground;
    private JScrollPane scpEmpTablaFondo;
    private JTable tblEmpTabla;

    public VRecursosHumanosReportes2(JFrame parentFrame) {
    ...
    private void initFrame(JFrame parentFrame) {
        ...
        String mes = JOptionPane.showInputDialog(this, "Ingrese mes a buscar (MM)");
        DefaultTableModel dtmModeloTabla = new MReportesDAO().vistaEmpleado(mes);
