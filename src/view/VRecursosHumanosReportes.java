 ...
 */
public class VRecursosHumanosReportes extends JDialog {

    private JPanel pnlBackground;
    private JScrollPane scpEmpTablaFondo;
    private JTable tblEmpTabla;

    public VRecursosHumanosReportes(JFrame parentFrame) {
    ...
    private void initFrame(JFrame parentFrame) {
        ...
        DefaultTableModel dtmModeloTabla = new MReportesDAO().DAOEmpRead();
