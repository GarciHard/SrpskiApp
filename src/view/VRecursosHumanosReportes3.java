 ...
 */
public class VRecursosHumanosReportes3 extends JDialog {

    private JPanel pnlBackground;
    private JScrollPane scpEmpTablaFondo;
    private JTable tblEmpTabla;

    public VRecursosHumanosReportes3(JFrame parentFrame) {
    ...
    private void initFrame(JFrame parentFrame) {
        ...
        DefaultTableModel dtmModeloTabla = new MReportesDAO().vistaVenta(mes);
